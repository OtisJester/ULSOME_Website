function createUnityInstance(t, n, d) {
    ...
    m.deinitializers.push(function () {
        for (var e in m.disableAccessToMediaDevices(), a.forEach(function (e) {
            ...
            }), window.removeEventListener("error", r), window.removeEventListener("unhandledrejection", r), document.removeEventListener("webkitfullscreenchange", u), m.intervals)
            window.clearInterval(e);
        m.intervals = {}
    }),
        ...
        if ("symbolsUrl" != e) {
            ...
            for (e in m.downloadProgress) {
                if (!(n = m.downloadProgress[e]).started)
                    return;
                a++,
                n.lengthComputable ? (r += n.loaded, o += n.total, i++) : n.finished || s++
            }
    ...
    m.SystemInfo = function () {
        ...
        i = [["Firefox", "Firefox"], ["OPR", "Opera"], ["Edg", "Edge"], ["SamsungBrowser", "Samsung Browser"], ["Trident", "Internet Explorer"], ["MSIE", "Internet Explorer"], ["Chrome", "Chrome"], ["CriOS", "Chrome on iOS Safari"], ["FxiOS", "Firefox on iOS Safari"], ["Safari", "Safari"]];
        function s(e, t, n) {
        ...
        [r] || r,
        webgpuVersion = 0,
        (f = document.createElement("canvas")) && (u = (p = f.getContext("webgl2")) ? 2 : 0, p || (p = f && f.getContext("webgl")) && (u = 1), p && (o = p.getExtension("WEBGL_debug_renderer_info") && p.getParameter(37446) || p.getParameter(7937)));
        ...
        function o() {
            return void 0 === e ? a.arrayBuffer().then(function (e) {
                ...
                if (e.done) {
                    ...
                    if (h < c)
                        return l.slice(0, h);
                    for (var t = new Uint8Array(h), n = (t.set(l, 0), f), r = 0; r < u.length; ++r)
                        t.set(u[r], n), n += u[r].length;
                    return t
                }
                return h + e.value.length <= l.length ? (l.set(e.value, h), f = h + e.value.length) : u.push(e.value),
                h += e.value.length,
                i({
                    type: "progress",
                    response: a,
    ...
    m.UnityCache = (h = {
        ...
        return this.getMetaDataEntries().then(function (e) {
            for (var t = e.metaDataEntries, n = e.cacheSize, r = [], o = [], a = 0; a < t.length; ++a)
                t[a].version == m.productVersion ? o.push(t[a]) : (r.push(t[a]), n -= t[a].size);
            o.sort(function (e, t) {
            ...
            return function e() {
                ...
                return 0 === r.length ? Promise.resolve() : (t = r.pop(), i.cache.delete(t.url).then(function (e) {
                        if (e)
                            return r = t.url, new Promise(function (e, t) {
    ...
    m.cachedFetch = (y = m.UnityCache, v = m.fetchWithProgress, S = m.readBodyWithProgress, function (o, a) {
        var e,
        t,
        i = y.getInstance(),
        ...
        function c(n, r) {
            return fetch(n, r).then(function (e) {
                ...
                return !d.enabled || d.revalidated ? e : 304 === e.status ? (d.revalidated = !0, i.updateRequestMetaData(d.metaData).then(function () {
                    ...
                    }), S(d.response, r.onProgress, r.enableStreamingDownload)) : 200 == e.status ? (d.response = e, d.metaData.updatedAt = d.metaData.accessedAt, d.revalidated = !0, t = e.clone(), S(e, r.onProgress, r.enableStreamingDownload).then(function (e) {
                        ...
                        e
                    })) : (U("'" + s + "' request failed with status: " + e.status + " " + e.statusText), S(e, r.onProgress, r.enableStreamingDownload))
            })
        }
        return a && (d.control = a.control, d.companyName = a.companyName, d.productName = a.productName, d.productVersion = a.productVersion),
        d.revalidated = !1,
        d.metaData = {
            url: s,
            accessedAt: Date.now(),
        ...
        d.enabled ? i.loadRequest(s).then(function (e) {
            ...
            return e ? (n = e.response, r = e.metaData, d.response = n, d.metaData.size = r.size, d.metaData.updatedAt = r.updatedAt, "immutable" == d.control ? (d.revalidated = !0, i.updateRequestMetaData(r).then(function () {
                        ...
                        d.revalidated ? (i.updateRequestMetaData(r).then(function () {
                                U("'" + d.metaData.url + "' successfully revalidated and served from the browser cache")
                            }), S(d.response, a.onProgress, a.enableStreamingDownload)) : c(o, a)
                    }))) : c(o, a)
        }).catch(function (e) {
    ...
    var A = {
        ...
        br: {
            hasUnityMarker: function (e) {
                ...
                if (commentOffset = 1 + n + 2 + 1 + 2 + (o << 3) + 7 >> 3, 17 == r || commentOffset > e.length)
                    return !1;
        ...
        m.preRun.push(function () {
            ...
            a.then(function (t) {
                ...
                for (n + s > t.length && o("Invalid binary data file header! (pos=" + n + ", headerSize=" + s + ", file length=" + t.length + ")"); n < s; ) {
                    ...
                    n += l;
                    for (var h = 0, f = u.indexOf("/", h) + 1; 0 < f; h = f, f = u.indexOf("/", h) + 1)
    ...
    return new Promise(function (e, t) {
        ...
        m.SystemInfo.hasWebGL ? 1 == m.SystemInfo.hasWebGL ? (n = 'Your browser does not support graphics API "WebGL 2" which is required for this content.', "Safari" == m.SystemInfo.browser && parseInt(m.SystemInfo.browserVersion) < 15 && (m.SystemInfo.mobile || 1 < navigator.maxTouchPoints ? n += "\nUpgrade to iOS 15 or later." : n += "\nUpgrade to Safari 15 or later."), t(n)) : m.SystemInfo.hasWasm ? m.SystemInfo.hasWasm2023 ? (m.startupErrorHandler = t, d(0), m.postRun.push(function () {
                ...
                D()
            })) : t("Your browser does not support WebAssembly 2023. Please update to Chrome \u2265 91 (May 2021), Firefox \u2265 89 (June 2021) or Safari \u2265 16.4 (March 2023). (failed " + m.SystemInfo.missingWasm2023Feature + ")") : t("Your browser does not support WebAssembly.") : t("Your browser does not support WebGL.")
    })
}
